...
NBL1:
		...
		andi	R21,0x01			;Ser om den er lige eller ulige - lige så er vi på ligestykke
		BRBc	SREG_Z,Ligestykke1	;Hopper til lige stykke hvis R21 er lige

		clc							;Clear carry for sikkerhedsskykd
		sub		NyL,Lap				;Trækker Lap fra ny
		sbc		NyH,R16				;Trækker Lap fra ny
		rjmp	END					;Hopper til slut

	Ligestykke1:
		clc							;Clear carry for sikkerhedsskyld
		Add		NyL,Lap				;Lægger Lap til ny
		adc		NyH,R16				;Lægger Lap til ny
		rjmp	END					;Hopper til slut
