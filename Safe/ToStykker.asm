...
; FUNKTIONERNE DER SKAL BRUGES:!
		...
		push	R16
TjekToFrem:
;		adiw	ZH:ZL,2					; Her skal den hoppe 2 frem. og tjekke om det er FE.
...
Tjek2:									
		...
		breq	Additionaftosidste 		; Hopper til addition hvis den er 0xFE og vi er fået enden af tabelen
		sbiw	ZH:ZL,1
